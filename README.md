...
Можно собрать колесо командами python3 setup.py build потом python3 setup.py sdist bdist_wheel потом перейти в папку dist разархивировать его командой wheel unpack snake-0.0.1-py3-none-any.whl перейти в папку snake-0.0.1(cd snake-0.0.1) потом в папку snake(cd snake) и запустить python3 snake.py  
### **GUI**  
